<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6 mt-14">
    <!-- Card 1 -->
    <a href="#" class="relative rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105">
