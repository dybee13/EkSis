...
<div class="bg-slate-100">
    ...
    <div id="post-container" class="flex justify-center gap-6 px-4 flex-wrap">
        ...
        <a href="/mainBlog" class="bg-white shadow-lg rounded-xl overflow-hidden w-80 block">
            <img src="image1.jpg" alt="Gambar 1" class="w-full h-48 object-cover">
            <div class="p-4">
                <span class="bg-green-600 text-white text-sm px-3 py-1 rounded-lg inline-block mb-2 -translate-y-[200px]">Admin</span>
                <p class="font-semibold text-lg">HIBAHKAN 70 TOPENG CEPETAN KEPADA BP GEOPARK KEBUMEN : MEDIA EDUKASI DAN PELESTARIAN BUDAYA LOKAL</p>
            </div>
        </a>

        <!-- Card 2 -->
        <a href="#" class="bg-white shadow-lg rounded-xl overflow-hidden w-80 block">
            <img src="image2.jpg" alt="Gambar 2" class="w-full h-48 object-cover">
            <div class="p-4">
                <span class="bg-green-600 text-white text-sm px-3 py-1 rounded-lg inline-block mb-2 -translate-y-[200px]">Admin</span>
                <p class="font-semibold text-lg">SISWA GUNAKAN ECO CRAFT UNTUK PROTOTIPE PEMBELAJARAN</p>
            </div>
        </a>

        <!-- Card 3 -->
        <a href="#" class="bg-white shadow-lg rounded-xl overflow-hidden w-80 block">
            <img src="image3.jpg" alt="Gambar 3" class="w-full h-48 object-cover">
            <div class="p-4">
                <span class="bg-green-600 text-white text-sm px-3 py-1 rounded-lg inline-block mb-2 -translate-y-[200px]">Pengurus</span>
                <p class="font-semibold text-lg">Implementasikan Gerakan PBLHS: Gaspala SMAN 2 Kebumen Tanam Cemara Laut di Kawasan Pesisir</p>
            </div>
        </a>
    </div>
