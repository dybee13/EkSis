<nav class="fixed top-0 z-50 w-screen border-b bg-gray-800 border-gray-700">
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r sm:translate-x-0 bg-gray-800 border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/masterDataEkskul" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
            ...
            <li>
                <a href="/masterDataPembina" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
