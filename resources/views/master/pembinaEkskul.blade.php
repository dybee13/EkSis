            ...
            <table class="w-full table-auto bg-white rounded-lg border border-gray-300">
                <thead>
                    <tr class="bg-gray-100 border-b">
                        ...
                        <th class="py-2 px-2 text-left text-gray-700">NIP</th>
                ...
                <tbody id="table-body">
                    <tr class="border-b" data-eskul="Rohis">
                        <td class="py-2 px-2">Roni S.pd.i</td>
                        <td class="py-2 px-2">3008213013</td>
                    ...
                    <tr class="border-b" data-eskul="Basket">
                        <td class="py-2 px-2">Maman S.pd.i</td>
                        <td class="py-2 px-2">30102391203</td>
                    ...
                    <tr class="border-b" data-eskul="Futsal">
                        <td class="py-2 px-2">Asep S.pd.i</td>
                        <td class="py-2 px-2">3290921302</td>
