...
<div class="w-full min-h-screen flex justify-center items-start mt-32 ml-32 px-6">
    <div class="w-full max-w-screen-lg bg-white p-6 rounded-lg shadow">
        ...
        <div class="mb-4 flex justify-between items-center">
            ...
            <button id="btnTambah" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">+ Tambah Guru</button>
        </div>
            ...
            <table class="w-full table-auto bg-white rounded-lg border border-gray-300 text-center">
                ...
                <tbody id="table-body">
                    ...
                    <tr class="border-b">
                        ...
                        <td>
                            <button id="btnDetail" class="btn btn-warning btnDetail"
                                data-id="{{ $pembina->id }}"
                                data-name="{{ $pembina->name }}"
                                data-email="{{ $pembina->email }}"
                                data-nohp="{{ $pembina->no_hp }}"
                                data-nip="{{ $pembina->nip }}"
